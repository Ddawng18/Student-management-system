...
Tính trừu tượng thể hiện ở việc mô hình hóa các đối tượng trong thế giới thực thành các lớp trong hệ thống, đồng thời chỉ giữ lại những đặc điểm quan trọng của đối tượng.
Trong hệ thống, các đối tượng thực tế được trừu tượng hóa thành các lớp như:
- SinhVien
- GiangVien
- MonHoc
- LopHoc
...
- Khoa
  ...
  **Ví dụ:**
Trong thực tế có nhiều sinh viên khác nhau. Mỗi sinh viên có các đặc điểm chung như:
mã sinh viên, họ tên, ngày sinh, email
Từ những đối tượng sinh viên cụ thể đó, hệ thống trừu tượng hóa thành lớp SinhVien để biểu diễn các đặc điểm chung của tất cả sinh viên.

## Tính đóng gói (Encapsulation)
Tính đóng gói thể hiện ở việc mỗi lớp trong hệ thống đảm nhiệm một nhóm chức năng riêng biệt và quản lý dữ liệu liên quan đến chức năng đó.
- SinhVien quản lý thông tin và hoạt động của sinh viên
- GiangVien quản lý thông tin và việc nhập điểm
- MonHoc quản lý thông tin môn học
- DangKyHoc quản lý quá trình đăng ký môn và lưu điểm
Mỗi lớp chịu trách nhiệm cho một phần chức năng riêng của hệ thống, giúp hệ thống được tổ chức rõ ràng và dễ quản lý.

**Ví dụ:**
- xử lý thông tin sinh viên → lớp SinhVien
- quản lý môn học → lớp MonHoc
- quản lý đăng ký học → lớp DangKyHoc

## Tính thừa kế (Inheritance)

Tính kế thừa là cơ chế cho phép một lớp có thể kế thừa lại các thuộc tính và phương thức của một lớp khác. Nhờ đó, hệ thống có thể tái sử dụng mã nguồn, giảm trùng lặp và dễ mở rộng. Có thể thiết kế kế thừa như sau:

Trong thực tế, SinhVien và GiangVien đều là con người và có các đặc điểm chung như:
- họ tên
- email
- mã

Vì vậy có thể tạo một lớp cha chung:
- họ tên
- email
- mã
...
-> Như vậy tránh lặp lại các thuộc tính chung (hoTen, email, ma).
## Các lớp:
- QuanLySinhVien
- QuanLyMonHoc
- QuanLyDangKy

Đều có bản chất là lớp quản lý dữ liệu (thêm, sửa, xóa, tìm).

Có thể xây dựng lớp cha:
...
Tính đa hình thể hiện ở việc cùng một phương thức nhưng có thể thực hiện các hành vi khác nhau tùy vào từng đối tượng cụ thể trong hệ thống.

Trong sơ đồ hệ thống quản lý sinh viên, tính đa hình được thể hiện thông qua các lớp:
- SinhVien
- GiangVien
- DangKyHoc
- QuanLySinhVien
- QuanLyMonHoc
- QuanLyDangKy
## Đa hình trong xử lý nghiệp vụ người dùng

Trong hệ thống:
- SinhVien có chức năng đăng ký môn học
- GiangVien có chức năng nhập điểm
- QuanLyDangKy xử lý việc đăng ký và tính kết quả

Mặc dù các lớp đều tham gia xử lý học tập, nhưng mỗi lớp sẽ thực hiện hành vi khác nhau.

Ví dụ:
- SinhVien gọi phương thức dangKyMonHoc()
- GiangVien gọi phương thức nhapDiem()
- DangKyHoc gọi phương thức tinhKetQua()

## Đa hình trong lớp DangKyHoc

Trong lớp DangKyHoc có phương thức:

tinhKetQua()

Phương thức này có thể được xây dựng theo nhiều cách khác nhau tùy vào quy định tính điểm:
- Tính theo điểm thi cuối kỳ
- Tính theo điểm quá trình + điểm thi
- Tính theo hệ đào tạo khác nhau
